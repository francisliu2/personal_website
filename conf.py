...
BLOG_AUTHOR = "Francis Liu"  # (translatable)
BLOG_TITLE = "Francis Liu"  # (translatable)
...
BLOG_EMAIL = "francisliutfp@gmail.com"
BLOG_DESCRIPTION = "This is a personal website of Francis Liu."  # (translatable)
